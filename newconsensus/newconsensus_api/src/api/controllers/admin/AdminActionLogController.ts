...
import { JsonController, Req, Res, Post, Body, Authorized} from 'routing-controllers';
...
export class AdminActionLogController {
     ...
     *    "status": "1"
     *  }
     * @apiSampleRequest /api/admin/actionlog/search
    ...
    /**
     * @api {post} /api/admin/actionlog/addlog Create Log of ActionLog
     * @apiGroup ActionLog
     ...
     *      "status": "1"
     * }
     * @apiSampleRequest /api/admin/actionlog/addlog
